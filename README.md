...
* The embedding models are released exclusively for **research purposes**.
* Please cite the [paper](http://www.lrec-conf.org/proceedings/lrec2018/pdf/929.pdf) if you use our embedding models.
